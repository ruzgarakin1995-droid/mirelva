      ...
      <div className="grid md:grid-cols-2 gap-16 md:gap-32 items-center">
        ...
        <motion.div 
          ...
          <h2 className="font-light leading-[1.1] tracking-tight text-[var(--primary)]" style={{ fontSize: 'clamp(2.5rem, 5vw, 5rem)' }}>
            Güzellik bir standart değil, kişisel bir imzadır.
          </h2>
          <div className="space-y-6 text-[var(--muted)] text-lg md:text-xl font-light leading-relaxed max-w-lg">
            <p>15 yılı aşkın tecrübemizle, lüksü ve bilimi aynı potada eritiyoruz. Kliniğimiz, sadece bir bakım merkezi değil, kendinize ayırdığınız en değerli zaman dilimidir.</p>
            <p>En son teknoloji cihazlar ve dünya çapında kanıtlanmış protokollerle, doğal güzelliğinizi ortaya çıkarıyoruz.</p>
          </div>
