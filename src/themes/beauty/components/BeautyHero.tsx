    ...
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <motion.div
          ...
          className="w-full h-full bg-[url('/beauty/laville-salon.jpg')] bg-cover bg-center"
        />
      ...
      <div className="relative z-10 text-center px-6 mt-32">
        ...
        >
          ...
          <p className={`${jost.className} tracking-[0.05em] text-lg md:text-xl text-[#FDFCF9]/95 max-w-2xl mx-auto mb-10 drop-shadow-md leading-[1.8] font-light`}>
            Kusursuz tırnak sanatı, profesyonel medikal ayak bakımı ve altın oran yüz tasarımlarıyla lüks bir bakım deneyimine davetlisiniz.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-5 items-center justify-center mt-6">
            <Link href="/test-beauty/hizmetler" className="inline-flex items-center justify-center border border-[#FDFCF9]/60 text-[#FDFCF9] font-sans font-medium text-[10px] tracking-widest uppercase px-8 py-3 rounded-full hover:bg-[#FDFCF9] hover:text-[#3E2B2B] transition-all duration-500 backdrop-blur-sm">
              Tüm Hizmetler
            </Link>
            <button onClick={() => window.dispatchEvent(new Event('openBeautyBooking'))} className="inline-flex items-center justify-center bg-[#D4A373] text-[#FDFCF9] font-sans font-medium text-[10px] tracking-widest uppercase px-8 py-3 rounded-full hover:bg-[#3E2B2B] hover:border-[#3E2B2B] transition-all duration-500 shadow-lg border border-[#D4A373]">
              Randevu Al
            </button>
          </div>
        </motion.div>
