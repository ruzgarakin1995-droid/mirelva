...
const images = [
  '/beauty/beauty_nails_1786272030225.jpg',
  '/beauty/beauty_lashes_1786272039522.jpg',
  '/beauty/beauty_spa_1786272048710.jpg',
  '/beauty/beauty_makeup_1786272894523.jpg'
];

export function BeautyInstagram() {
  return (
    <section className="py-24 bg-[#3E2B2B] overflow-hidden">
      <div className="text-center mb-16">
         <motion.div
          ...
          <p className="font-sans text-[#FAF5F0]/60 text-sm mt-4 tracking-widest uppercase">@laville.beauty</p>
      </div>
