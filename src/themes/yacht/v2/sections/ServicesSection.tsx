      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-light text-blue-800 mb-4">Size Özel Deneyim</h3>
          ...
          >
            ...
            <img src="/yacht_interior.jpg" alt="VIP Hizmetlerimiz" className="relative rounded-2xl shadow-xl w-full h-[400px] object-cover" />
          </motion.div>
        </div>
      </div>
    </section>
