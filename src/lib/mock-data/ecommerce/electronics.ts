...
export const techProducts = [
  ...
  // ==========================================
  {
    ...
    thumbnail: "/images/products/laptop.jpg",
    categoryIds: ["cat-1"],
    brand: "Apple",
    isNew: true,
    inStock: true,
  ...
  // ==========================================
  {
    ...
    thumbnail: "/images/products/smartphone.jpg",
    categoryIds: ["cat-2"],
    brand: "Apple",
    isNew: true,
    inStock: true,
  ...
  // ==========================================
  {
    ...
    images: ["/images/products/gaming.jpg"],
    thumbnail: "/images/products/gaming.jpg",
    categoryIds: ["cat-4"],
    brand: "Sony",
    isNew: true,
    inStock: true,
  ...
  // ==========================================
  {
    ...
    thumbnail: "/images/products/smarthome.jpg",
    categoryIds: ["cat-5"],
    brand: "Dyson",
    isNew: false,
    inStock: true,
