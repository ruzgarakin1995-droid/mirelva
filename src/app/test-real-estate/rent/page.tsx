...
export default function RentPage() {
  ...
  const rentProperties = realEstateProperties.filter(p => p.status === 'Kiralık');
    ...
    <div className="w-full bg-[#f5f5f0] min-h-screen py-12 px-6 md:px-12">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="mb-16">
          ...
          >
            Kiralık <span className="font-serif italic text-[#1a1a1a]/60">Portföy</span>
          </motion.h1>
          <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            ...
            {CATEGORIES.map(category => (
              ...
              >
                ...
                {activeFilter === category && (
                  <motion.div 
                    layoutId="activeFilterIndicatorRent"
        ...
        {filteredProperties.length === 0 && (
          <div className="py-24 text-center text-[#1a1a1a]/50 text-lg">
            Bu kategoride kiralık ilan bulunmamaktadır.
          </div>
        )}
