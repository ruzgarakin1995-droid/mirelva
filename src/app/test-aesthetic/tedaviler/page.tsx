      ...
      <section className="pt-48 pb-20 px-6 lg:px-8 bg-[#1C1C1C] text-[#FDFCF9] overflow-hidden relative">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-[10px] font-sans font-medium tracking-[0.3em] uppercase text-[#FDFCF9]/50">Klinik Protokoller</span>
            <div className="w-8 h-[1px] bg-[#C4A79A]"></div>
          </motion.div>
          <motion.h1 
          ...
          >
            Alanında öncü doktorlarımız tarafından uygulanan, FDA onaylı güncel estetik ve dermatolojik teknolojiler.
          </motion.p>
        </div>
      </section>

      {/* Reuse Services Component */}
      <AestheticServices />
      
      {/* Reuse Skincare (Product Line) Component */}
      <AestheticSkincare />
