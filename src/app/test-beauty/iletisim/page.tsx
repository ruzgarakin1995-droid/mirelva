    ...
    <main className="bg-[#FAF5F0] min-h-screen text-[#3E2B2B] selection:bg-[#D4A373] selection:text-[#FAF5F0]">
      ...
      <section className="pt-48 pb-24 px-6 lg:px-8 bg-[#3E2B2B] relative overflow-hidden">
        <div className="absolute inset-0 z-0">
           <img src="/beauty/beauty_interior_detail_1786272904875.jpg" alt="La Ville Interior" className="w-full h-full object-cover opacity-20" />
            ...
            <div className="space-y-10">
              ...
              <div className="flex gap-6 items-start group">
                ...
                <div>
                  ...
                  <p className="font-sans text-[#3E2B2B]/80 leading-relaxed">
                    LaVille Güzellik Salonu, Merkez<br/>
                    Abide-i Hürriyet Cd no:51, 34360<br/>
                    Şişli/İstanbul
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6 items-start group">
                ...
                <div>
                  ...
                  <p className="font-sans text-[#3E2B2B]/80 leading-relaxed">
                    <a href="tel:+905528945550" className="hover:text-[#D4A373] transition-colors block mb-1">+90 552 894 55 50</a>
                    <a href="mailto:lavilleguzelliksalonu@gmail.com" className="hover:text-[#D4A373] transition-colors block">lavilleguzelliksalonu@gmail.com</a>
                  </p>
                </div>
              </div>
