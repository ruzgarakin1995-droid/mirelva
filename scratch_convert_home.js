...
export default function TechHomePage() {
  return (
    <div className="w-full bg-slate-50 text-slate-900 selection:bg-blue-500/30 font-sans overflow-hidden">
      ...
      <section className="py-24 pl-4 md:pl-8 overflow-hidden bg-white border-t border-slate-200">
         <FadeIn>
            <div className="max-w-7xl mx-auto flex items-end justify-between pr-4 md:pr-8 mb-10">
               <h2 className="text-3xl font-bold text-slate-900">Yeni Çıkanlar.</h2>
               <Link href="/test-ecommerce-v2/shop" className="hidden md:flex items-center gap-2 text-blue-600 hover:text-blue-700 font-bold">
...
`;
fs.writeFileSync(pagePath, newHomePage, 'utf8');
console.log('Homepage converted to Light Mode.');
