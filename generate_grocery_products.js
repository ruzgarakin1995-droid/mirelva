...
const targetPath = 'src/lib/mock-data/ecommerce/grocery.ts';

const content = `import { EcommerceProduct, EcommerceCategory } from '@/types/ecommerce';
...
console.log("Grocery products updated with 50 local image products!");
